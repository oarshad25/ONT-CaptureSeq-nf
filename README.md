...
| `panel_gene_list`  | string | Path to file of list of genes in capture target panel, one _gene id_ per line |  |
| `select_gene_list`  | string | Path to file of list of a few genes of particular interest, one gene per line, whose read stats are to be included in report generated by pipeline |  |
